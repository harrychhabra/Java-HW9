...
public class CountingGame
{
    ...
    public static void main(String args[])
    {
        ...
        for(int i=0;i<max;i++)
        {
        	// adding players in Alist
        	players.add(i+1);
        }
        
        System.out.println("The players list is " + players);
        // Taking rhyme from user
        rhyme = getRhyme();
        int ans=0;
        for(int i=0;i<max-1;i++)
        {
        	// Process and eleminates the last speaking player
   ...
   public static int doRhyme(ListInterface<Integer> players, ListInterface<String> rhyme, int startAt)
    {
	   ...
	   {
		   // Traversing Rhyme lineraly and players circularly
...
//            Take input till end of line or enter key is pressed
